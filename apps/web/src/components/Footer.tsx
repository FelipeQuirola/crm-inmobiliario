      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <img src="/logo.png" alt="HomeMatch" className="h-12 w-auto brightness-0 invert" />
            <p className="mt-4 text-sm leading-relaxed text-white/60">
              Empresa inmobiliaria comprometida con la seguridad y transparencia
              en cada transacción. Quito, Ecuador.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href={`https://wa.me/${WA_NUM}`} className="hover:text-white">+593 98 619 5044</a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="mt-0.5 h-4 w-4 flex-shrink-0 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
                <a href="mailto:info@homematchinmobiliaria.com" className="break-all hover:text-white">
                  info@homematchinmobiliaria.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-8 sm:flex-row">
          <p className="text-xs text-white/40">
            © {new Date().getFullYear()} HomeMatch. Todos los derechos reservados.
          </p>
